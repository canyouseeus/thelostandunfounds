...
BUTTONS = {
    ...
    "btn-pay-deposit": "PAY DEPOSIT",
    "btn-pay-balance": "PAY BALANCE",
    "btn-open-gallery": "OPEN YOUR GALLERY",
    "btn-view-invoice": "VIEW INVOICE",
}
...
def main():
    ...
    ts_path = Path(__file__).resolve().parent.parent / "lib" / "email-buttons.generated.ts"
    lines = [
