...
description: Identifies and filters test/dummy revenue data from real customer transactions. Use when viewing revenue dashboards, generating reports, or user mentions "test data in revenue", "fake transactions", or "filter test orders".
---
