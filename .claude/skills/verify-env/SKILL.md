---
name: verify-env
description: Checks if critical environment variables are set for the project. Use before running dev server, deploying, or when API calls fail with auth errors. Validates Supabase, Google, and VITE variables.
---
