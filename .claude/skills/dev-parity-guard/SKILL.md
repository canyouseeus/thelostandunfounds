...
description: Maintains parity between development and production environments by validating scripts, proxies, and project structure. Use when setting up local dev, debugging environment differences, or before deploying to production.
---
