...
description: How to diagnose and fix Google Drive gallery sync issues. Use when photos are not syncing, gallery shows stale data, or sync cron jobs fail in production or local development.
---
