---
name: fix-paypal-mcp
description: Diagnose and fix PayPal MCP server initialization issues. Use when PayPal MCP fails to start, npx errors occur, or user mentions "PayPal MCP broken" or "MCP server not connecting".
---
