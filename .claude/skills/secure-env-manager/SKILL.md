...
description: Securely manage environment variables without exposing them in chat logs. Use when setting up env vars, rotating secrets, or user asks to configure API keys, tokens, or credentials. Never paste secrets directly.
---
