---
name: paypal-verify
description: Tools and instructions for verifying PayPal credentials and catching hidden character issues. Use when PayPal API returns auth errors, credentials seem correct but fail, or environment mismatch is suspected.
---
