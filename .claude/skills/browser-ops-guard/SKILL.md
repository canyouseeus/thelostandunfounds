...
description: Optimizes browser usage to reduce system overhead and ensures code quality via console verification. Use when launching browser for testing, taking screenshots, or verifying UI changes.
---
