...
description: Logic and rules for the dashboard clock widget interaction. Use when modifying the clock widget, stopwatch, or timer in the admin dashboard. Use when user mentions "clock format", "stopwatch", or "timer widget".
---
