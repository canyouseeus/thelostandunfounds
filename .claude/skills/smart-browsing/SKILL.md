---
name: smart-browsing
description: Strict guidelines for browser interaction - single tab only, patience for loading, visible UI confirmation. Use when opening browser for testing or verification tasks.
---
