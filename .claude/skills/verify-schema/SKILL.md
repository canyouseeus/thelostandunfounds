---
name: verify-schema
description: Checks database schema integrity and data consistency. Use when suspecting schema drift, after migrations, or when queries return unexpected results. Validates critical columns and legacy data.
---
