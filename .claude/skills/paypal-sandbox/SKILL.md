---
name: paypal-sandbox
description: Manages PayPal sandbox environment for local testing. Use when testing payment flows locally, configuring sandbox credentials, or debugging PayPal integration in development mode.
---
