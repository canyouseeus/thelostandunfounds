...
description: Ensures all modal/overlay components use proper z-index layering to prevent header overlap issues. Use when adding modals, overlays, popups, dropdowns, or fixing z-index stacking bugs. Use when user mentions "modal behind header", "overlay not showing", "z-index", or "popup hidden".
---
