...
description: Protocols for managing Google Service Account credentials and onboarding new photographers. Use when adding gallery sources, rotating credentials, or setting up new photographer integrations.
---
