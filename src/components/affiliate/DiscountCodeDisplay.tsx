...
export default function DiscountCodeDisplay({ affiliateCode, discountPercent, creditBalance, isActive }: DiscountCodeDisplayProps) {
  ...
  if (!isActive) {
    return (
      <div className="bg-black/50 rounded-none p-6 opacity-50">
    ...
    <div className="bg-black/50 rounded-none p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          <div className="flex-1 bg-white/10 rounded-none px-4 py-3 flex items-center justify-center">
      ...
      {/* Credit Balance */}
      <div className="bg-green-400/10 rounded-none p-4 mb-6">
      ...
      {/* Usage Instructions */}
      <div className="bg-blue-500/10 rounded-none p-4 mt-6">
