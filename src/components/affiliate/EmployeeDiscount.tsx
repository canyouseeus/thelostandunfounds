    ...
    <div className="bg-black/50 border-0 rounded-none p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          <div className="flex-1 bg-white/10 border-0 rounded-none px-4 py-3 flex items-center justify-center min-w-0">
            <span className="text-white text-xs sm:text-base md:text-2xl font-mono font-bold tracking-wider break-all text-center">{discountCode}</span>
          </div>
          <button
            onClick={copyCode}
      ...
      <div className="bg-white/10 border-0 rounded-none p-4">
        <h4 className="text-white font-medium mb-2">💡 How Employee Discount Works</h4>
