    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
            ...
            <div className="bg-green-900/20 rounded-none p-4">
              ...
              <div className="flex gap-2 mb-3">
                <input
                  ...
                  value={blogUrl}
                  readOnly
                  className="flex-1 px-4 py-2 bg-black/50 rounded-none text-white text-sm font-mono"
                />
                <button
                  type="button"
                  onClick={async () => {
              ...
              <div className="bg-blue-500/10 rounded-none p-3 mt-3">
                ...
                <ol className="text-white/80 text-xs space-y-1 list-decimal list-inside">
                  ...
                  <li>When asked for your website URL, paste: <code className="block mt-1 px-2 py-1 bg-black/50 rounded-none font-mono text-xs break-all">{blogUrl}</code></li>
          ...
          <div className="bg-blue-900/20 rounded-none p-3">
