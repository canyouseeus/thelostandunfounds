...
export default function AuthModal({ isOpen, onClose, message, title }: AuthModalProps) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {message && (
            <div className="mb-6 px-4 py-3 bg-white/10 border border-white/20 text-white text-sm leading-relaxed">
              {message}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="px-4 py-2 bg-red-500/20 border border-white rounded-none text-red-400 text-sm">
                {error}
              </div>
            )}
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full px-4 py-2 bg-black/50 border border-white rounded-none text-white font-medium hover:border-white transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
