    ...
    return (
        <div className="min-h-screen bg-black text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                {events.length === 0 ? (
                    <div className="text-center py-24 bg-white/5 border border-white/10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {events.map((event) => (
                            <div key={event.id} className="group border border-white/10 bg-white/5 hover:bg-white/10 transition-colors flex flex-col h-full">
                                {event.image_url && (
                                    <div className="aspect-video w-full overflow-hidden bg-black/50 border-b border-white/10 relative">
                                        <img
                                            src={event.image_url}
                                            alt={event.title}
                                            className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity"
                                        />
                                        <div className="absolute top-4 right-4 bg-black text-white text-xs font-bold uppercase px-3 py-1 border border-white/20">
