  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`${SITE.origin}/${column === 'main' ? 'thelostarchives' : column === 'bookclub' ? 'book-club' : column}`} />
        <meta name="description" content={description} />
        <meta property="og:title" content={`THE LOST+UNFOUNDS | The Lost Archives | ${title}`} />
        <meta property="og:description" content={description} />
        <meta property="og:url" content={`${SITE.origin}/${column === 'main' ? 'thelostarchives' : column === 'bookclub' ? 'book-club' : column}`} />
