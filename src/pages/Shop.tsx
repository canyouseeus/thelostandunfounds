    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
      ...
      {selectedProduct && (
        <ProductModal
          ...
          onStrikeCheckout={setLightningPayment}
        />
      )}
...
function ProductModal({
  ...
  const handleCheckoutClick = async (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    try {
      ...
      console.log('⚡ Starting Strike (Bitcoin) checkout for product:', {
        id: product.id,
        title: product.title,
        price: product.price,
      });
      ...
      console.log('⚡ Strike invoice created:', result.invoiceId);

      // Close product modal and open Lightning payment modal
      onClose();
      onStrikeCheckout({
      ...
      console.error('❌ Error creating Strike checkout:', error);
