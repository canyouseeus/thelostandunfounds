...
export default function About() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-white mb-8 tracking-wide" style={{ fontWeight: 900, letterSpacing: '0.1em', whiteSpace: 'nowrap' }}>ABOUT : THE LOST+UNFOUNDS</h1>
      </div>
