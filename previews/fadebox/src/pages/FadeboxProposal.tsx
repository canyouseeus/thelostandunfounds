      ...
      <div className="fbprop">
        ...
        <section className="page">
          ...
          <div className="cover-body">
            {/* logo.png is white-on-transparent — invisible on this white cover, so use the inverted mark */}
            <div className="cover-logo"><img src="/logo-black.png" alt="THE LOST+UNFOUNDS" /></div>
        ...
        <section className="page">
          ...
          <div className="stat-row">
            ...
            <div className="cell"><div className="n">4,800+</div><div className="l">Reviews · team-wide</div></div>
          ...
          <p className="body">
            The reputation is there — 4.9 stars across 4,800+ reviews. But underneath, booking is a patchwork: some barbers on Booksy, some on Squire, some on links that break — no single place to book, no single place to see sales and schedules. A fifth studio only multiplies that. Unify it now and every location you open runs on one system: one front door for customers, one dashboard of real numbers for you.
          </p>
          ...
          <div className="callout soft">
            ...
            <div className="v">A working preview is live now — <strong><a href="/">the landing page</a></strong> and the owner dashboard at <strong><a href="/dashboard">/dashboard</a></strong>. Try the booking flow. This isn't a mockup you have to imagine; it already runs.</div>
          </div>
