...
export function buildBookingPaymentEmailBody(args: {
  ...
  return `
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 24px 0;">
      <tr>
        <td style="background-color: #f5f5f5;padding:20px 24px;">
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 16px 0;">
      <tr>
        <td align="center" style="background-color: #000000;">
          <a href="${escapeHtml(args.paymentUrl)}" style="display:block;padding:16px 24px;color:#ffffff;font-size:14px;font-weight:bold;letter-spacing:0.15em;text-transform:uppercase;text-decoration:none;font-family:Arial,Helvetica,sans-serif;">
