...
export async function sendShopDigitalDeliveryEmail(args: {
    ...
    const body = `
        ...
        <div style="margin-bottom:40px;padding:20px;border:1px solid #333;background:#111;">
            <a href="${downloadUrl}" style="display:inline-block;padding:12px 24px;background:#000;color:#fff;text-decoration:none;font-weight:bold;text-transform:uppercase;font-size:13px;letter-spacing:1px;">Download</a>
