...
export async function sendShopDigitalDeliveryEmail(args: {
    ...
    const body = `
        <h1 style="color:#000000;text-transform:uppercase;letter-spacing:-1px;font-size:28px;font-weight:bold;margin:0 0 10px;">Your Download is Ready</h1>
        ...
        <div style="margin-bottom:40px;padding:20px;border:1px solid #333;background:#111;">
            <a href="${downloadUrl}" style="display:inline-block;padding:12px 24px;background:#ffffff;color:#000000;text-decoration:none;font-weight:bold;text-transform:uppercase;font-size:13px;letter-spacing:1px;">Download</a>
