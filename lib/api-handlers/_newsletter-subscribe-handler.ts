            ...
            <table role="presentation" style="max-width: 600px !important; width: 100% !important; border-collapse: collapse !important; background-color: #ffffff !important; margin: 0 auto !important;">
              ...
              <tr>
                <td style="padding: 0 !important; color: #000000 !important; background-color: #ffffff !important;">
                  ...
                  <hr style="border: none; border-top: 1px solid #dddddd; margin: 30px 0; background-color: #ffffff !important;">
                  <p style="color: #666666 !important; font-size: 12px; line-height: 1.5; margin: 0; text-align: center; background-color: #ffffff !important;">
                    If you didn't sign up for this newsletter, you can safely ignore this email.
                  </p>
  <p style="color: #666666 !important; font-size: 12px; line-height: 1.5; margin: 20px 0 10px 0; text-align: center; background-color: #ffffff !important;">
    © ${new Date().getFullYear()} THE LOST+UNFOUNDS. All rights reserved.
  </p>
  <p style="color: #666666 !important; font-size: 12px; line-height: 1.5; margin: 10px 0 0 0; text-align: center; background-color: #ffffff !important;">
    <a href="https://www.thelostandunfounds.com/api/newsletter/unsubscribe?email=${encodeURIComponent(email)}" style="color: #666666 !important; text-decoration: underline;">Unsubscribe from this newsletter</a>
  </p>
                </td>
              </tr>
            </table>
