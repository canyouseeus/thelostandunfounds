  ...
  switch (type) {
    case 'welcome': {
      ...
      return {
        ...
        content: `
          <h1 style="color:#000;font-size:20px;font-weight:bold;letter-spacing:0.05em;margin:0 0 8px 0;text-transform:uppercase;white-space:nowrap;">W3 COM3 TO 3AT YOR BRAIN!!!</h1>
