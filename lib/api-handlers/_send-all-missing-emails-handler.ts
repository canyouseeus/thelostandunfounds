...
function generateNewsletterConfirmationBody(subscriberEmail?: string): string {
  return `
    ...
    <p style="color: rgba(0, 0, 0, 0.6); font-size: 12px; line-height: 1.5; margin: 0; text-align: center;">
      If you didn't sign up for this newsletter, you can safely ignore this email.
    </p>
    <p style="color: rgba(0, 0, 0, 0.6); font-size: 12px; line-height: 1.5; margin: 20px 0 0 0; text-align: center;">
      <a href="https://www.thelostandunfounds.com/api/newsletter/unsubscribe?email=${encodeURIComponent(subscriberEmail || '')}" style="color: rgba(0, 0, 0, 0.6); text-decoration: underline;">Unsubscribe from this newsletter</a>
    </p>
  `
}
