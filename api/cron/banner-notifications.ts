                ...
                await sendTransactionalEmail({
                    ...
                    content: `
                        ...
                        <div style="margin: 30px 0;">
                            <img src="${campaign.image_url}" style="width: 100%; height: auto;" />
                        </div>
                        <p style="color: #aaaaaa; font-size: 14px;">
                            Your content is being rotated across our Gallery, Shop, and Blog surfaces.
                        </p>
                        <div style="text-align:center;"><a href="https://www.thelostandunfounds.com" style="display: inline-block; margin-top: 20px; padding: 12px 24px; background-color: #ffffff; color: #000000; text-decoration: none; font-weight: 900; font-size: 12px; text-transform: uppercase; letter-spacing: 2px;">View Live Site</a></div>
                    `
                });
            ...
            if (!existingIdle || existingIdle.length === 0) {
                await sendTransactionalEmail({
                    ...
                    content: `
                        ...
                        <div style="background-color: rgba(255, 255, 255, 0.1); border-left: 4px solid #f59e0b; padding: 20px; margin: 20px 0;">
                    ...
                    if (!alreadyReplaced || alreadyReplaced.length === 0) {
                        await sendTransactionalEmail({
                            ...
                            content: `
                                ...
                                <div style="text-align:center;"><a href="https://www.thelostandunfounds.com/advertise" style="display: inline-block; padding: 12px 24px; background-color: #ffffff; color: #000000; text-decoration: none; font-weight: 900; font-size: 12px; text-transform: uppercase; letter-spacing: 2px;">Buy New Slots</a></div>
                            `
                        });
